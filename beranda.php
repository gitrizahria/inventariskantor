    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-success">
                <strong>Selamat Datang di Sistem Informasi Inventaris Barang Kantor Direktorat SDA dan TTG,KEMENDES RI</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Daftar Inventaris Barang Kantor Direktorat SDA dan TTG,KEMENDES RI</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th><center>No.</center></th><th><center>Kode</center></th><th><center>Nama Barang</center></th><th><center>Merk</center></th><th><center>Letak Barang</center></th><th><center>Jumlah</center></th><th><center>Status</center></th>
                            </tr>
                        </thead>
                        <tbody>
